// Static sample products for Homme - solaires
(function(){
  const products = [
    ...
    { id: 'm-s-3', name: 'Lunettes Soleil Homme C', price: 22000, image: 'https://via.placeholder.com/300x200?text=H+S+3', gender:'men', type:'solaire' }
  ];
